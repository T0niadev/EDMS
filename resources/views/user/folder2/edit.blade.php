...
@section('content')
  ...
  <main class="main-content w-full px-[var(--margin-x)] pb-8">
    <div class="pt-6">
      ...
      <div class="flex items-center space-x-1">
        ...
        <div class="flex my-1 h-10 mb-2 rounded border-bottom">
          <a href="{{ url($folderb->department_id, 'folders') }}" >
    ...
    <form  method="POST" action="{{ url('1sttier/update',$folderb->id) }}" enctype="multipart/form-data">
                ...
                <div class="card space-y-5 p-4 sm:p-5">
                  <label class="block">
                    ...
                    <input 
                      ...
                      placeholder="" type="text"  name="name" value="{{$folderb->name}}"/>
                  </label>
