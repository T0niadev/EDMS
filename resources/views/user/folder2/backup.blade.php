...
@section('content')
  ...
  <div class="mt-4">
   <p class="text-2xl font-semibold"><a href="{{ url($foldera->department->id, 'folders') }}" class="text-2xl font-semibold" > {{ $foldera->department->name}}</a>  >> {{ $foldera->name}}  </p>
    <button
      ...
      <a href="{{ url($foldera->id, 'subfolders/add') }}"> Add New Sub-folder</a>


    </button>
    <button
      class="btn h-9 min-w-[7rem] mt-4  bg-primary font-medium text-white hover:bg-primary-focus focus:bg-grey-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
      <a href="{{ url($foldera->id, 'subfiles/add') }}"> Upload New File</a>
                ...
                <div class="card group p-3 h-30 w-60">
                    ...
                    <div class="relative mt-4">
                        ...
                        <button
                            ...
                            <a 
                            href="{{ asset($fileb->document) }}"> Download</a>
                        </button>
                        </div>
                    </div>
