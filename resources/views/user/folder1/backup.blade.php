...
@section('content')
  ...
  <div class="mt-4">
   <p class="text-2xl font-semibold">
    <!-- <a href="/departments"class="text-2xl font-semibold" >Departments</a> -->
    {{$department->name}} </p>
   ...
   <button
      ...
      <a href="{{ url($department->id, 'folders/add') }}"> Add New folder</a>
      

    </button>
    <button
      class="btn h-9 min-w-[7rem] mt-4  bg-primary font-medium text-white hover:bg-primary-focus focus:bg-grey-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
      <a href="{{ url($department->id, 'files/add') }}"> Upload New Document</a>
                ...
                <div class="card group p-3 h-30 w-60">
                    ...
                    <div class="relative mt-4">
                        ...
                        <button
                            ...
                            <a 
                            href="{{ asset($filea->document) }}"> Download</a>
                        </button>
                        </div>
                    </div>
