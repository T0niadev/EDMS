...
@section('content')
  ...
  <main class="main-content w-full px-[var(--margin-x)] pb-8">
    ...
    <form  method="POST" action="{{ url('folder/update',$foldera->id) }}" enctype="multipart/form-data">
                ...
                <div class="card space-y-5 p-4 sm:p-5">
                  <label class="block">
                    ...
                    <input 
                      ...
                      placeholder="" type="text"  name="name" value="{{$foldera->name}}"/>
                  </label>
