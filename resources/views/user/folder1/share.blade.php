...
@section('content')
  ...
  <main class="main-content w-full px-[var(--margin-x)] pb-8">
    <div class="pt-6">
      ...
      <div class="flex items-center space-x-1">
        ...
        <div class="flex my-1 h-10 mb-2 rounded border-bottom">
          <a href="{{ url($foldera->department_id, 'folders') }}" >
            <p class="text-2xl text-gray-900 dark:text-white">
             {{$foldera->department->name}} >> {{$foldera->name}}
            </p>
          </a>
        </div>
      </div>
    ...
    <form  method="POST" action="{{ url('1sttier/share',$foldera->id) }}" enctype="multipart/form-data">
                ...
                <div class="border-b-2 border-slate-150 dark:border-navy-500">
                  <div class="tabs-list -mb-0.5 flex">
                    <button
                      ...
                      <span>Share {{$foldera->name}} with</span>
                    </button>
              ...
              <div class="tab-content p-4 sm:p-5">
                <div class="card space-y-5 p-4 sm:p-5">
                  ...
                  <div class="flex">
                      ...
                      <form id="assigntouser" method="POST" action="a" enctype="multipart/form-data">
                         
                          <button class="mt-1.5"  value="{{$user->id}}"  onclick="document.getElementById('assigntouser').submit();">
                            <svg class="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                              <path fill="#currentColor" d="M8 13a1 1 0 0 1-.707-.293l-2-2a1 1 0 1 1 1.414-1.414l1.42 1.42 5.318-3.545a1 1 0 0 1 1.11 1.664l-6 4A1 1 0 0 1 8 13Z"/>
                            </svg>
