...
@section('content')
  ...
  <div class="mt-4">
      ...
      <p class="text-2xl font-semibold"> 
        <a href="{{ url($folderb->foldera->department->id, 'folders') }}" class="text-2xl font-semibold" >{{$folderb->foldera->department->name}} >></a>
        <a href="{{ url($folderb->foldera->id, 'subfolders') }}" class="text-2xl font-semibold" > {{$folderb->foldera->name}} >> </a>
        {{$folderb->name}}
     </p>
   <button
      class="btn h-9 min-w-[7rem] mt-4  bg-primary font-medium text-white hover:bg-primary-focus focus:bg-grey-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
      <a href="{{ url($folderb->id, 'subfolders/2ndtier/add') }}"> Add New Sub folder</a>
    </button>
    <button
      class="btn h-9 min-w-[7rem] mt-4  bg-primary font-medium text-white hover:bg-primary-focus focus:bg-grey-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
      <a href="{{ url($folderb->id, 'subfiles/2ndtier/add') }}">Upload New Document</a>
    </button>
                ...
                <div class="card group p-3 h-30 w-60">
                    ...
                    <div class="relative mt-4">
                        ...
                        <button
                            ...
                            <a 
                            href="{{ asset($filec->document) }}"> Download</a>
                        </button>
                        </div>
                    </div>
